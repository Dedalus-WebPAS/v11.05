//jsVersion  : V11.05.00
//
// Source Code:  ./ipad/allweb0202810.js
//
// Modification 
//
...
function SaveAction() {
  if(UpdateForm.alref129.value.indexOf(" ") == 0) {
    alertify.alert("Can't have space at the first place");
    return;
  }
...
function init() {
 ...
 if (RefStatus=="Rejected  "){
   ...
   document.UpdateForm.alref129.value=CurrentDate;
   document.UpdateForm.alref130.value=CurrentTime;
