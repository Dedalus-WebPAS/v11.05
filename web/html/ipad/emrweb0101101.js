//jsVersion  : V11.05.00
//
// Source Code:  ./ipad/emrweb0101101.js
//
// Modification 
//
// Version   Date       Responsible/Changes Made
//------------------------------------------------------------------------------
// V10.08.01 11.11.2016 B.G.Ackland   
//                      Remove colon from arrival date and time. During Manual Review.
...
/*****
 *	This file heavily relies on ipad.js please make sure it is loaded in the templates
 *****/
 ...
 for(var i = 0; i < PatientRecords.rows.length; i++) {
   ...
   if (ListFilter(PatientRecords.rows[i])) {
     ...
     OS += "<li class=sectionItem onclick='LinkPatient(\""+i+"\");'>" + 
           ...
           "<span class=subscriptRight style='position:absolute;right:2%;'>"+PatientRecords.rows[i][11] + "</span>" +
           "<br><span class=subscriptLeft>Problem: "+PatientRecords.rows[i][34] + "</span>" +
           "<span class=subscriptRight>"+PatientRecords.rows[i][2] + "</span>" +
           "<br><span class=ntTimeframe>Arrival: "+
           FormatCommentAge(PatientRecords.rows[i][7]) + "</span>" +
           "<span class=ntWhen>"+
