...
//------------------------------------------------------------------------------
// V11.03.02 14/03/2023 Don Nguyen    TSK 0912141
//                      Removed validation on Doctors Contact Number to prevent
//                      the Priority field selection from resetting.
// V11.03.01 07/02/2023 Don Nguyen    TSK 0912141
//                      Made 'Doctors Contact Number' field (optfld17) mandatory
//                      when shown and fixed bug where the field was not
//                      validating the value entered as a Number only.
//                      Added new screening questions for applicable Group Code
//                      (Category) values of Radiology / Pathlogy order codes.
//                      Modified page submit code to only show the waiting
//                      dialog after successful validation of the page.
// V11.01.01 13/10/2021 Don Nguyen    TSK 0912011
//                      Added search filtering for Lab Code & Group ID in
//                      SearchOrderCodes()
// V10.14.01 22/11/2019 Don Nguyen    TSK 0880715
//                      Added User Id validation functions.
//                      Modified AddTest() to include Service Type (resultType)
//                      code in list item.
// V10.08.01 13.05.2016 B.G.Ackland CAR 314279
//                      Add break in LookupTest to avoid duplicate codes being added to array
// V10.06.01 09.09.2015 B.G.Ackland CAR 314279
//                      Add Radiology Optional Fields Type option for Type 6,7,8,9
// V10.05.01 03.09.2014 B.G.Ackland CAR 305689
//                      Change AddSet to start from index 0.
// V10.04.02 29.04.2014 B.G.Ackland CAR 289383
//                      Default "Type of Units" to Index 1 RBC
// V10.04.01 16.04.2014 B.G.Ackland CAR 289383
//                      Check mapping for All Codes not just from Test Sets.
// V10.03.11 21.02.2014 B.G.Ackland CAR 289383
//                      New Search Arrangements
// V10.03.10 11.02.2014 B.G.Ackland CAR 289383
//                      Check Age of Result for setResultValue
//                      Remove Additional Fields from fieldType 2
// V10.03.09 03.02.2014 B.G.Ackland CAR 289383
//                      Default Time to 07:00 if default not today
//                      Mandate Units for Blood Product Issue
// V10.03.08 03.02.2014 B.G.Ackland CAR 289383
//                      Default Time to 08:00 if default not today
// V10.03.07 21.01.2014 B.G.Ackland CAR 289383
//                      Added Notes Type 5 for Cross Match to Mandate Units
// V10.03.06 13.01.2014 B.G.Ackland CAR 289383
//                      Change "Save" button to "Order"
// V10.03.05 16.12.2013 B.G.Ackland CAR 289383
//                      Change search Input Field to a Type of text and not search
// V10.03.04 04.12.2013 B.G.Ackland CAR 
//                      Fix Blood Product Fields
// V10.03.03 02.10.2013 B.G.Ackland CAR 
//                      IOS7 Workarround for alert and confirm
...
function ShowPatientTests(sType) {
  ...
  xmlHttp.onreadystatechange = function() {
	...
	OS += "<li class=sectionItem onclick=\"AddPatientTest('"+null+"',"+
	       ...
	       displayName +
               "<span style='font-size:10px;position: absolute;right:30px;margin-top:-13px;'>" + 
	       obj[i].labname + "</span>"+
...
function ValidUserId() {
  ...
  if (returnValue.status == 0) {
    ...
    alertify.alert("Web Service (PATWEB98) Not Available. " +
