//jsVersion  : V11.05.00
//
// Source Code:  ./ipad/FormFunctions.js
//
// Modification 
//
...
function checkPassAdd() {
  if (isWhitespace(CurrentDiv.AddForm.securety.value)) { return;; }
  var serverURL   = CGIPath + "patweb80.pbl?reportno=11" +
  ...
  if (returnValue.status==0) {
    ...
    CurrentDiv.AddForm.secureid.value="";
    CurrentDiv.AddForm.securepw.value="";
    CurrentDiv.AddForm.secureid.focus();

  }
}
function checkPassUpd() {
  if (isWhitespace(CurrentDiv.UpdateForm.securety.value)) { return;; }
  var serverURL   = CGIPath + "patweb80.pbl?reportno=11" +
  ...
  if (returnValue.status==0) {
    ...
    CurrentDiv.UpdateForm.secureid.value="";
    CurrentDiv.UpdateForm.securepw.value="";
    CurrentDiv.UpdateForm.secureid.focus();
