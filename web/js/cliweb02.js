...
//========================================================================
//========================================================================
// cliweb0203001 - Edit Observation Type
//========================================================================
...
// 01 : CTAS : UpdateObs, Insert:  resize observations popup
//     DFrameSubmit(PatientLinks,25,25,750,450)
         DFrameSubmit(PatientLinks,25,25,1050,600);
//         // end of change
  }
}
//========================================================================
...
function UpdateObs(linkURL) {
  DFrameLink(linkURL,25,25,1050,600)
}
/*
function UpdateObs(linkURL) {
...
function GraphBP() {
 ...
 if(isWhitespace(Dataset0dateValue) || isWhitespace(Dataset0yValue) ||
    isWhitespace(Dataset1dateValue) || isWhitespace(Dataset1yValue) ||
    isWhitespace(Dataset2dateValue) || isWhitespace(Dataset2yValue)) {
...
function GraphAll() {
 ...
 if(isWhitespace(Dataset0dateValue) || isWhitespace(Dataset0yValue) ||
    isWhitespace(Dataset1dateValue) || isWhitespace(Dataset1yValue) ||
    isWhitespace(Dataset2dateValue) || isWhitespace(Dataset2yValue) ||
    isWhitespace(Dataset3dateValue) || isWhitespace(Dataset3yValue) ||
    isWhitespace(Dataset4dateValue) || isWhitespace(Dataset4yValue)) {
