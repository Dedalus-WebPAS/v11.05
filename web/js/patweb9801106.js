...
if (parent.notesViewAll != undefined) {
  notesViewAll = parent.notesViewAll;
}
...
function NoteInitTable() {
 ...
 for(var i = 0; i < t.rows.length; i++) {
   if(appendNoteDescriptionInDischargeSummary=="1"){
   theText="<b>"+t.rows[i][9]+" "+"Note:</b><br>" +
          "<br>"+ t.rows[i][10].replace(/\'/g,"`");
////removed - br requested by hec .replace(/<br>/gi," ")+"<br>";
   } else {
