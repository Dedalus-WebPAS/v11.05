...
//  d.writeln('}');
  ...
  d.writeln('#BlackHole {');
  d.writeln('position: absolute;');
  d.writeln('top:405px;left:2px;width:200px;height:90px;');
  d.writeln('background-color:#000000;');
  d.writeln('position: absolute;');
  d.writeln('}');
  ...
  d.writeln('top: 180px;left:210px;width:390px;height:135px;');
  d.writeln('background-color:#cccccc;');
  d.writeln('}');
  d.writeln('#SmallTableLocation {');
  d.writeln('position: absolute;');
  d.writeln('overflow: auto;');
  d.writeln('top: 315px;left:210px;width:390px;height:82px;');
  d.writeln('background-color:#cccccc;');
  d.writeln('}');
