...
function ShowMap(immediate,emergency,urgent,semi,non) {
  ...
  d.writeln('top: 318;left:605;width:200px;height:85px;');
  d.writeln('background-color:#cccccc;');
  d.writeln('clip: rect(0px,200px,85px,0px)');
  d.writeln('}');

  d.writeln('#EmergencyCount {');
  d.writeln('position: absolute;');
  d.writeln('top: 357px;left:203;width:196px;height:45;');
  d.writeln('background-color:#ffff00;');
  d.writeln('}');

  d.writeln('#BlackHole {');
  d.writeln('position: absolute;');
  d.writeln('top:405;left:605px;width:200px;height:45px;');
  ...
  d.writeln('position: absolute;');
  d.writeln('top:405;left:404px;width:200px;height:45px;');
  d.writeln('background-color:#000000;');
  d.writeln('position: absolute;');
  d.writeln('}');
  ...
  d.writeln('position: absolute;');
  d.writeln('top:405;left:203px;width:200px;height:45px;');
  d.writeln('background-color:#000000;');
  d.writeln('position: absolute;');
  d.writeln('}');
  ...
  d.writeln('position: absolute;');
  d.writeln('top:357;left:404px;width:200px;height:44px;');
  d.writeln('background-color:#000000;');
  d.writeln('position: absolute;');
  d.writeln('}');
  ...
  d.writeln('top: 182;left:245px;width:510px;height:138;');
  d.writeln('background-color:#cccccc;');
  d.writeln('}');
