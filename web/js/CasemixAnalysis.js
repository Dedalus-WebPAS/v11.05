...
//               CasemixAnalysis.js.js with arrays for TableString. 
//               CasemixAnalysisOLD.js is
...
//    v9.02.03   14.11.2001  Glenn Saunders - fix "t.rows.1 object not found"
//               Remove the following line of script from func TableTotals
//                      t.rows[1][t.columns[j][2]]    before last <td>
//               Remove the following line of script from func TableBody
//                      t.rows[i][t.columns[j][2]]    before last <td>
...
function AddDataSet(RowNo,GraphValue) {
 ...
 Value = parseInt(t.rows[RowNo][GraphValue],10,10,10,10,10,10,10,10,10,10);
