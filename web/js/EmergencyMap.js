...
function showOutOfDept(locIndex) {
  if (!ShowPatients) return;
   ...
   var cells_wide=obj.locations[locIndex][11];
    ...
    if (obj.patients[r][16]==obj.locations[locIndex][1]&&obj.locations[locIndex][8]!="W"){
      if(shownRetain==false) {
        LocationMap+="<div id=Location-"+locIndex+
              ...
              " patientsHigh='"+obj.locations[locIndex][12]+"' "+
              " class='LocationStyle styleLoc-"+obj.locations[locIndex][1]+"'>"+
              "<table class=OutOfDept border=1 cellpadding=0 " +
              "cellspacing=0 "+
      ...
      displaycolumnswide++;
      LocationMap+="<td align=right><table class=OutOfDept " +
...
function SelectMapViewType(el) {
  ...
  top.SetCookie("EmergencyMapViewType",ViewType,316224000);
  top.location.reload();
}
//
...
function getPatientCell01(i) {
  ...
  if (obj.patients[i][15] == "1") {
    ...
    PatientMap+='<td style="width:73px;background-color:white"><span class=cellPatientNameTr1P>' +
               obj.patients[i][2].replace(/ *$/,"").replace(/ /g,"_") + '</span></td>';
  }else {
  ...
  if(VariableNameExists('ShowCabEdIpBedRequests')) {
    if(ShowCabEdIpBedRequests && !isWhitespace(obj.patients[i][64])) {
     if(obj.patients[i][64].substr(0,1)=="B") {
       PatientMap+='<span class="Black Bold">' +
                   obj.patients[i][64].substr(1) +
                   '</span>'
     }
     if(obj.patients[i][64].substr(0,1)=="R") {
       PatientMap+='<span class="Red Bold">' +
                   obj.patients[i][64].substr(1) +
                   '</span>'
     }
     if(obj.patients[i][64].substr(0,1)=="G") {
       PatientMap+='<span class="Green Bold">' +
                   obj.patients[i][64].substr(1) +
                   '</span>'
     }
    }
...
function getPatientCell03(i) {
  ...
  if (obj.patients[i][15] == "1") {
    ...
    PatientMap+='<td style="width:75px;background-color:white;color:red">'+
                '<span class=cellPatientNameTr1P>' +
                obj.patients[i][2].replace(/ *$/,"").replace(/ /g,"_") + '</span></td>';
  } else {
...
//
// Sjog Patient Cell Configuration
//
function getPatientCell04(i) {
  ...
  PatientMap+='\n--------------------------------------------------">' +
              ...
              TriageColor(obj.patients[i][4]) + '> ' 
// Cell 1
  if (obj.patients[i][58] == "Y") {
    PatientMap+='<td style="text-align:center;width:22px;background-color:pink"'
  }
  else {
    PatientMap+='<td style="text-align:center;width:22px;"'
  }
  PatientMap+=' class=cellPatientLocName>' +
    getLocationAlias(obj.patients[i][3]) + '&nbsp;</td>';
// Cell 2
  if (obj.patients[i][15] == "1") {
    PatientMap+='<td style="width:73px;background-color:white"><span class=cellPatientNameTr1>' +
...
// Cell 3
  PatientMap+='<td style="text-align:center;width:25px;">' + obj.patients[i][6] +
              obj.patients[i][7] + '&nbsp;</td>'
// Cell 4
  if (obj.patients[i][62] == "D") {
    PatientMap+='<td style="text-align:center;width:30px"><img src="../images/rhombus-grey-20.png" class=icon</td>'
//    PatientMap+='<td style="text-align:center;width:30px"><img src="../images/FullDetailsGreen.gif" class=icon</td>'
  } else if (obj.patients[i][62] == "H") {
    PatientMap+='<td style="text-align:center;width:30px"><img src="../images/OrganIcon.gif" class=icon</td>'
  } else if (obj.patients[i][62] == "S") {
    PatientMap+='<td style="text-align:center;width:30px"><img src="../images/star-yellow-20.png" class=icon</td>'
  } else if (obj.patients[i][62] == "F") {
    PatientMap+='<td style="text-align:center;width:30px"><img src="../images/ballpink.gif" class=icon</td>'
  } else if (obj.patients[i][62] == "B") {
    PatientMap+='<td style="text-align:center;width:30px"><img src="../images/ball_blu.gif" class=icon</td>'
  } else if (obj.patients[i][62] == "G") {
    PatientMap+='<td style="text-align:center;width:30px"><img src="../images/FullDetailsGreen.gif" class=icon</td>'
  } else if (obj.patients[i][62] == "I") {
    PatientMap+='<td style="text-align:center;width:30px"><img src="../images/GreyH.png" class=icon</td>'
  } else if (obj.patients[i][62] == "J") {
    PatientMap+='<td style="text-align:center;width:30px"><img src="../images/GreyV.png" class=icon</td>'
  } else if (obj.patients[i][62] == "K") {
    PatientMap+='<td style="text-align:center;width:30px"><img src="../images/YellH.png" class=icon</td>'
  } else if (obj.patients[i][62] == "L") {
    PatientMap+='<td style="text-align:center;width:30px"><img src="../images/YellV.png" class=icon</td>'
  } else if (obj.patients[i][62] == "M") {
    PatientMap+='<td style="text-align:center;width:30px"><img src="../images/GreenH.png" class=icon</td>'
  } else if (obj.patients[i][62] == "N") {
    PatientMap+='<td style="text-align:center;width:30px"><img src="../images/GreenV.png" class=icon</td>'
  } else if (obj.patients[i][62] == "O") {
    PatientMap+='<td style="text-align:center;width:30px"><img src="../images/PurpH.png" class=icon</td>'
  } else if (obj.patients[i][62] == "P") {
    PatientMap+='<td style="text-align:center;width:30px"><img src="../images/PurpV.png" class=icon</td>'
  } else if (obj.patients[i][62] == "Q") {
    PatientMap+='<td style="text-align:center;width:30px"><img src="../images/RedH.png" class=icon</td>'
  } else if (obj.patients[i][62] == "R") {
    PatientMap+='<td style="text-align:center;width:30px"><img src="../images/RedV.png" class=icon</td>'
  } else {
    PatientMap+='<td style="text-align:center;width:30px"><img src="../images/blank.png" class=icon</td>'
  }
// Cell 5
  PatientMap+='<td style="text-align:center;width:25px;">' + obj.patients[i][5].substr(8,5) +
              '&nbsp;</td></tr>' +
...
// Cell 7
  PatientMap+='<td>' + obj.patients[i][59].replace(/\s/g,"") + '</td>';
// Cell 8
  if  (obj.patients[i][12]=="000000000") {
    PatientMap+='<td>' + obj.patients[i][41].replace(/\s/g,"") +'&nbsp;</td>';
  } else {
...
// Cell 9
  PatientMap+='<td>' + obj.patients[i][60].replace(/\s/g,"") +
              '&nbsp;</td></tr>' 
// Cell 10
  PatientMap+='<tr style="height:'+PatientLineHeight+
              'px" bgcolor=#cccccc><td colspan=2>'
  PatientMap+=obj.patients[i][63]
  PatientMap+='&nbsp;</td>'
// Cell 11
  PatientMap+='<td>' + obj.patients[i][19].replace(/\s/g,"") +
              '&nbsp;</td>';
// Cell 12
  PatientMap+='<td>' + obj.patients[i][61] + '&nbsp;</td>'; 
// Cell 13
// discharge time emvidtim
  if(!isWhitespace(obj.patients[i][43])) {
    PatientMap+='<td>' + obj.patients[i][43].substr(0,5) + '&nbsp;</td>'
