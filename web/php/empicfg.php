...
.----------------------------------------------------------------------
.
PRGID     INIT      "empicfg.php"
VERSION   INIT      "V11.05.00"
PRGNAM    INIT      "WA Health EMPI Interface Config Details"
.
.----------------------------------------------------------------------
*/
    define("WEB_SERVICE_URI","https://test-dataservices.hdwa.health.wa.gov.au/Client/EMPI/services/1/0/EmpiService.svc?wsdl");
    define("USERNAME","HIN-WebPASApp-TST");
    define("PASSWORD","TST-ppASAPbeW-NIH");
    ...
    define("APPLICATION_VERSION","10.00.01");
