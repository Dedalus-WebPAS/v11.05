...
.----------------------------------------------------------------------
. Program       : ical01_ltz.php
.
. Function      : ICS Calendar Subscription
.
. Modifications :
.----------------------------------------------------------------------
PRGID     INIT      "ical01_ltz.php"
...
*/
 ...
 $qry = "select
      ...
      and ( opcldoct=(select wbsedoc from websecaf where wbseuid='$uid')
            or opseclin=(select wbsedoc from websecaf where wbseuid='$uid'))
union all
select
        ...
        ,' '
        ,' '
        ,'../../cgi-bin/outweb02.pbl?reportno=02&template=004&sesskeys='||rpad(osesite,6,'+')||rpad(oseclin,6,'+')||osedate||osestrt eventlink
      from outsesaf
      ...
      and   osedate < '$todate'
      and ( ocadoct=(select wbsedoc from websecaf where wbseuid='$uid')
            or ocaccons=(select wbsedoc from websecaf where wbseuid='$uid')
            or oseclin=(select wbsedoc from websecaf where wbseuid='$uid'))
";
